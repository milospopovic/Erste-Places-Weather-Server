...
/**
 * Implementation of service for downloading data from openweather api
 */
class OpenWeatherServiceImpl(
    private val restTemplate: RestTemplate,
    private val openWeatherProperties: OpenWeatherProperties,
) : OpenWeatherService {
    private val log: Logger = LoggerFactory.getLogger(OpenWeatherServiceImpl::class.java)
    ...
    override fun getCurrentWeather(city: String, countryCode: String?): WeatherData? {
